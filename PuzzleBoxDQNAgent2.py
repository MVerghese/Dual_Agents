...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, savepath='checkpoint.pth',load=False, loadpath='checkpoint.pth'):
...
def main():
    agent = Agent(state_size=35,action_size=5,seed=0)
